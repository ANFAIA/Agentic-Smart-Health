...
>
> Contraparte en código: [`packages/core-schemas/models.py`](../../packages/core-schemas/models.py).
> Diagrama interactivo (privado): <https://claude.ai/code/artifact/de67c0fe-0c52-4530-ac50-0f939acacac9>
