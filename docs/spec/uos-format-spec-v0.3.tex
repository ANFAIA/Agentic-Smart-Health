...
\begin{itemize}
  ...
  ⚠️ \textbf{This has been exercised once, and it is recorded rather than left implicit.}
  \code{uos-spec-v0.3} was moved on 2026-09-24, one day after it was first pushed. What it
  ...
  not resolve, because a 404 is visible. A validator check
  (\S\ref{sec:conformance}) now compares what a tag publishes against the file in the tree,
  so the next occurrence is found before anybody downloads it.
