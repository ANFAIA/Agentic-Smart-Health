...
decides, in the open, on the record of the request. A version is published by tagging the
repository, which is what makes the schema's identifier resolve to that version rather than
to whatever a branch holds today.
