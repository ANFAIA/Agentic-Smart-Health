...
\emph{generated} from the reference implementation's types, never hand-written.

\quad\textbf{What it does and does not check.} It is the only artifact a third party needs
...
Example container & \code{another\_patient.uos} --- 12 entries, 18 views,
3 declared extensions, provenance chain of 3 versions. It is the container this document quotes
whenever it shows a real value.\\
\bottomrule
\end{longtable}
